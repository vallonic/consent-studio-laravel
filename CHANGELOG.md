...
- `@consentstudio` directive for main script injection
- `@consent` / `@endconsent` directive for smart content blocking
- Google Consent Mode v2 support
- Full configuration via config file and environment variables
